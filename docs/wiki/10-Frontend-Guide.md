...
| `/new` | **New ticket** | analyst, admin (blocked by URL for others, like every restricted page) | Required: summary, description, reporter. Optional "Set details yourself" for every AI-fillable field. Buttons: *Create and watch AI triage* / *Create only* |
